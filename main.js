...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getUserSpecificDetails = function () {
        ...
        this.sharedService.get('getUserWeather/:' + this.userCity).subscribe(function (data) {
